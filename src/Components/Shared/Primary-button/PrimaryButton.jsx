const PrimaryButton = ({ 
  ...
  // Variant styles
  const variants = {
    primary: 'bg-gradient-to-r from-orange-400 to-orange-500 hover:from-orange-500 hover:to-orange-600 text-white shadow-lg hover:shadow-xl focus:ring-orange-300',
    secondary: 'bg-white hover:bg-gray-50 text-orange-500 border-2 border-orange-500 hover:border-orange-600 focus:ring-orange-300',
    outline: 'bg-transparent hover:bg-orange-50 text-orange-500 border-2 border-orange-500 hover:border-orange-600 focus:ring-orange-300',
